...
namespace Kinect.Toolbox
{
    public class SkeletonDisplayManager
    {
        ...
        public void Draw(Skeleton[] skeletons, bool seated, int mainTrackedId = 0) //我加了mainTrackedId參數和相關判斷，為了只畫主要玩家
        {
            ...
            foreach (Skeleton skeleton in skeletons)
            {
                ...
                if (mainTrackedId != 0 && skeleton.TrackingId != mainTrackedId)
                    continue;
