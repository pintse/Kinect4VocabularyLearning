...
{
    /// <summary>
    /// Ryan:EyeTracker: Using the new Face Tracking system of the SDK 1.5, this class allows you to detect if the user is currently looking at the sensor (to avoid detecting unwanted gestures)
    /// </summary>
