...
{
    public class GMoveToLeftOrRightDetector : GestureDetector  //Ryan:Algorithmic search作法
    {
        ...
        public GMoveToLeftOrRightDetector(int windowSize = 20)
            : base(windowSize)
        {
        ...
        public GMoveToLeftOrRightDetector(string gestureName, int windowSize = 20)
            : this(windowSize)
        {
            this.GestureName = gestureName;
        }

        public GMoveToLeftOrRightDetector()
            : this(20) 
        {
        }
        ...
        protected override void LookForGesture()  //Ryan:Algorithmic search作法
        {
            ...
            if (this.GestureName.EndsWith("MoveToRight"))
            {
            ...
            if (this.GestureName.EndsWith("MoveToLeft"))
            {
