...
{
    class GHeadShakeDetector : GestureDetector  //Ryan:Algorithmic search作法
    {
        ...
        private double Epsilon = 1500;
        private bool SwipeToRightFlag = false, SwipeToLeftFlag = false;

        readonly string GestureName; 

        public GHeadShakeDetector(int windowSize = 60)
            : base(windowSize)
        {
            SwipeMinimalLength = 0.03f;
            SwipeMaximalHeight = 0.3f;
            SwipeMininalDuration = 250;
            SwipeMaximalDuration = 2500;
        }

        public GHeadShakeDetector(string gestureName, int windowSize = 60)
            : this(windowSize)
        {
            this.GestureName = gestureName;
        }

        public GHeadShakeDetector()
            : this(60) 
        {
        }
