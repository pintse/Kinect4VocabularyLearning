...
{
    public class PFrontHandLeftDetector : PostureDetector
    {
        private GlobalData.GestureTypes Name = GlobalData.GestureTypes.PFrontHandLeft;

        public float Epsilon {get;set;}
        public float MaxRange { get; set; }

        public PFrontHandLeftDetector() : base(0)
        {
            Epsilon = 0.1f;
            MaxRange = 0.25f;
        }
        ...
        public override void TrackPostures(Skeleton skeleton)
        {
            ...
            if (check(shoulderCenter, leftHandPosition))
            {
